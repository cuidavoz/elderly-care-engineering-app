...
/**
 * Sidebar contextual. Muestra el inicio, el listado de familias del cuidador
 * (selección de familia activa) y un acceso a la gestión de familias.
 * La familia activa se deriva del pathname (`/dashboard/[familyId]/...`).
 */
export function DashboardSidebar({
  ...
  // Familia activa: primer segmento después de /dashboard que sea un id de
  // familia conocido (descarta rutas como /dashboard/familia).
              ...
              >
                <span
                  className={cn(
                    ...
                    activeFamilyId === family.id ? "bg-primary" : "bg-muted-foreground/40"
                  )}
                />
